...
# --- Sub Agent 1: MarketResearcher ---
# This agent will perform market research using Google Search
...
# This agent will craft key messaging based on market research
# It will automatically receive the output of the previous agent (MarketResearcher)
...
# This agent will generate ad copy variations based on key messaging
# It will automatically receive the output of the previous agent (MessagingStrategist)
...
# This agent will suggest visual concepts based on ad copy variations
# It will automatically receive the output of the previous agent (AdCopyWriter)
# It will also use the MCPImageGenTool to generate images
